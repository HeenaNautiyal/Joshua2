...
public class FirstAidnew extends AppCompatActivity {
    ...
    String abc, mobile, fname, address, city, state, license, email, Epdate, mail, mail1,medid;
    TextView tv;
    ...
    protected void onCreate(Bundle savedInstanceState) {
        ...
        setContentView(R.layout.activity_first_aidnew);
       ...
       /* getSupportActionBar().setDisplayOptions(android.support.v7.app.ActionBar.DISPLAY_SHOW_CUSTOM);
        ...
        new JSONAsyncTask().execute("http://d2dmedicine.com/aPPmob_lie/insertdata.php?caseid=27&catid=15");
        ...
        btnback.setOnClickListener(new View.OnClickListener() {
            ...
            public void onClick(View v) {
                Intent it = new Intent(FirstAidnew.this,MainActivity3.class);
                startActivity(it);
            }
        });
    ...
    private void selectionorder() {
        Intent it = new Intent(FirstAidnew.this,Ordernow.class);
        Bundle b = new Bundle();
