...
public class Register extends AppCompatActivity {
    ...
    private class Registration extends AsyncTask<String, String, String> {
        ...
        protected String doInBackground(String... strings) {
            ...
            String url = "http://outsourcingservicesusa.com/d2d/insertdata.php?caseid=1&fname="+fnamw1.replaceAll(" ", "")+"" +
                    "&lname="+lname1.replaceAll(" ", "")+"&email="+email1.replaceAll(" ", "")+"" +
                    "&password="+password1.replaceAll(" ", "")+"&mobilenumber="+number1+"&pincode="+pincode1+"" +
                    "&houseno="+house1.replaceAll(" ", "")+"&colony="+colony1.replaceAll(" ", "")+"" +
                    "&city="+city1.replaceAll(" ", "")+"&state="+state1.replaceAll(" ", "")+"";
