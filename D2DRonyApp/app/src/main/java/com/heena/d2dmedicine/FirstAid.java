...
public class FirstAid extends AppCompatActivity {
    ...
    String TAG="OTCClass";
    Button btn_continue;
    String Med,Menu,Comp,aaa,adminfont,addrss,city,state,stname;
    ...
    protected void onCreate(Bundle savedInstanceState) {
        ...
        stname=(String)b.getCharSequence("storename");
            ...
            public void onClick(View v) {
                ...
                for (Chemist actors : actorsList) {
                    if (actors.getIsRowSelected()) {
                        ...
                        Intent it = new Intent(FirstAid.this, Confirm.class);
                        Bundle b = new Bundle();
                        b.putString("Medicine", Med);
                        b.putString("Menufacture", Menu);
                        b.putString("Added", stname);
                        it.putExtras(b);
                        startActivity(it);
