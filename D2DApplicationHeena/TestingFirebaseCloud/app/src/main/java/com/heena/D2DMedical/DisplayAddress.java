...
public class DisplayAddress extends AppCompatActivity {
    ...
    String TAG = "Display Address",mail,st1,st2,st3,st4,st5,st6,st7,st8,address,city;
    Button btn,OK1;
    ...
    protected void onCreate(Bundle savedInstanceState) {
        ...
        new JSONAsyncTask().execute("http://d2dmedicine.com/aPPmob_lie/insertdata.php?caseid=19&email="+mail1+"");
                    ...
                    builder.setPositiveButton("Continue.",
                            new DialogInterface.OnClickListener() {
                                public void onClick(DialogInterface dialog,
                                                    int which) {
                                  Intent it = new Intent(DisplayAddress.this, OrderPlace1.class);
                                    Bundle b= new Bundle();
                                    b.putString("address",st3);
                                    b.putString("city",st4);
                                    it.putExtras(b);
                                    startActivity(it);
                                }
                            });
                    ...
                    builder.setPositiveButton("Continue.",
                            new DialogInterface.OnClickListener() {
                                public void onClick(DialogInterface dialog,
                                    ...
                                    Intent it = new Intent(DisplayAddress.this, OrderPlace1.class);
                                    Bundle b= new Bundle();
                                    b.putString("address",st7);
                                    b.putString("city",st8);
                                    it.putExtras(b);
                                    startActivity(it);
                                }
                            });
