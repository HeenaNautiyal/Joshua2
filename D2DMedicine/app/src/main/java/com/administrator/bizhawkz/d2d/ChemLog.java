...
public class ChemLog extends AppCompatActivity {
    ...
    protected void onCreate(Bundle savedInstanceState) {
        ...
        if (connec.getNetworkInfo(0).getState() == android.net.NetworkInfo.State.CONNECTED ||
            ...
            android.app.AlertDialog.Builder builder = new android.app.AlertDialog.Builder(com.administrator.d2d.ChemLog.this);
            TextView myMsg = new TextView(com.administrator.d2d.ChemLog.this);
        ...
        btnLog.setOnClickListener(new View.OnClickListener() {
            ...
            public void onClick(View view) {
                ...
                if (email.matches("") || password.matches("")) {
                    AlertDialog.Builder builder = new AlertDialog.Builder(com.administrator.d2d.ChemLog.this);
                    TextView myMsg = new TextView(com.administrator.d2d.ChemLog.this);
                    ...
                    Intent it = new Intent(com.administrator.d2d.ChemLog.this, UploadMedicine.class);
                    startActivity(it);
                    new Logmem().execute();
                }
            }
        ...
        protected void onPostExecute(String result) {
            try {
                ...
                if (message.equals("1")) {
                    ...
                    builder.setPositiveButton("Continue.",
                            new DialogInterface.OnClickListener() {
                                public void onClick(DialogInterface dialog,
                                    ...
                                    editor.putString("username",email);
                                    editor.commit();
                                    Intent it = new Intent(com.administrator.d2d.ChemLog.this, Mem.class);
                                    startActivity(it);
                                    ed_email.setText("");
                                    ed_password.setText("");
                                }
                    ...
                    final AlertDialog.Builder builder = new AlertDialog.Builder(com.administrator.d2d.ChemLog.this);
                    TextView myMsg = new TextView(com.administrator.d2d.ChemLog.this);
                    myMsg.setText("Warning!");
                    myMsg.setGravity(Gravity.CENTER_HORIZONTAL);
                    myMsg.setTextSize(20);
