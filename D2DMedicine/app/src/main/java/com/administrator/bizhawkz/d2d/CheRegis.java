...
public class CheRegis extends AppCompatActivity implements View.OnClickListener {

    ImageView submit;
    ProgressDialog pb;
    SharedPreferences settings,pwd;
    EditText fname, lname, email, password, number, pincode, licence, date,addr,city,state;
    String fnamw1, lname1, email1, password1, number1, pincode1, lcnumber, date1,addr1,city1,state1;
    ...
    private void setDateTimeField() {
        date.setOnClickListener(CheRegis.this);
    ...
    private class Registration extends AsyncTask<String, String, String> {
        ...
        protected String doInBackground(String... strings) {
            ...
            String url = "http://seajob.net/medicalapp/insertdata.php?caseid=4&fname="+fnamw1.replaceAll(" ", "")+"&lname="+lname1.replaceAll(" ", "")+"&email="+email1.replaceAll(" ", "")+"&password="+password1.replaceAll(" ", "")+"&mobileno="+number1+"&address="+addr1.replaceAll(" ","")+"&city="+city1.replaceAll(" ","")+"&state="+state1.replaceAll(" ","%")+"&pincode="+pincode1+"&licenseno="+lcnumber.replaceAll(" ", "")+"&expirydate="+date1.replaceAll(" ", "")+"";
        ...
        protected void onPostExecute(String result) {
            try {
                ...
                if (message.equals("1")) {
                    ...
                    editor.commit();*/
                    AlertDialog.Builder builder = new AlertDialog.Builder(com.administrator.d2d.CheRegis.this);
                    TextView myMsg = new TextView(com.administrator.d2d.CheRegis.this);
                    myMsg.setText("Congratulations!");
                    myMsg.setGravity(Gravity.CENTER_HORIZONTAL);
                    myMsg.setTextSize(20);
                    myMsg.setTextColor(Color.BLACK);
                    ...
                    builder.setPositiveButton("Continue.",
                            new DialogInterface.OnClickListener() {
                                public void onClick(DialogInterface dialog,
                                    ...
                                    Intent it = new Intent(com.administrator.d2d.CheRegis.this, SearchChemist.class);
                                    startActivity(it);
                    ...
                    final AlertDialog.Builder builder = new AlertDialog.Builder(com.administrator.d2d.CheRegis.this);
                    TextView myMsg = new TextView(com.administrator.d2d.CheRegis.this);
