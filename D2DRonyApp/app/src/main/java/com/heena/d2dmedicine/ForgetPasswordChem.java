        ...
        protected void onPostExecute(String result) {
            try {
                ...
                if (message.equals("1")) {
                    ...
                    editor.commit();
                    AlertDialog.Builder builder = new AlertDialog.Builder(ForgetPasswordChem.this);
                    TextView myMsg = new TextView(ForgetPasswordChem.this);
                    ...
                    builder.setPositiveButton("Continue.",
                            new DialogInterface.OnClickListener() {
                                public void onClick(DialogInterface dialog,
                                                    int which) {
                                    Intent it = new Intent(ForgetPasswordChem.this, Mem.class);
                                    startActivity(it);
                                    etpf.setText("");
                                }
                            });
                    ...
                    final AlertDialog.Builder builder = new AlertDialog.Builder(ForgetPasswordChem.this);
                    TextView myMsg = new TextView(ForgetPasswordChem.this);
