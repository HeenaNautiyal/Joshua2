...
public class CheRegis extends AppCompatActivity {
    ...
    private class Registration extends AsyncTask<String, String, String> {
        ...
        protected String doInBackground(String... strings) {
            ...
            String url1="http://outsourcingservicesusa.com/d2d/insertdata.php?caseid=2&email="+email1.replaceAll(" ","")+"&password="+password1.replaceAll(" ","")+"";
    ...
    private class Registration2 extends AsyncTask<String, String, String>{
        ...
        protected String doInBackground(String... strings) {
           ...
           // String url1="http://outsourcingservicesusa.com/d2d/insertdata.php?caseid=2&email="+email1.replaceAll(" ","")+"&password="+password1.replaceAll(" ","")+"";
            ...
            String url="http://outsourcingservicesusa.com/d2d/insertdata.php?caseid=4&fname="+fnamw1.replaceAll(" ", "")+"&lname="+lname1.replaceAll(" ", "")+"" +
                    ...
                    "&licenseno="+lcnumber.replaceAll(" ", "")+"&expirydate="+date1.replaceAll(" ", "")+"&date=&token=&type=0";
