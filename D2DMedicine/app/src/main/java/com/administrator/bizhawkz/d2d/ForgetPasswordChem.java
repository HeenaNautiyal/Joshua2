...
public class ForgetPasswordChem extends AppCompatActivity {
    EditText etpf;
    Button btn;
    String email;
        ...
        protected void onPostExecute(String result) {
            try {
                ...
                if (message.equals("1")) {
                    ...
                    editor.commit();
                    AlertDialog.Builder builder = new AlertDialog.Builder(com.administrator.d2d.ForgetPasswordChem.this);
                    TextView myMsg = new TextView(com.administrator.d2d.ForgetPasswordChem.this);
                    ...
                    builder.setPositiveButton("Continue.",
                            new DialogInterface.OnClickListener() {
                                public void onClick(DialogInterface dialog,
                                                    int which) {
                                    Intent it = new Intent(com.administrator.d2d.ForgetPasswordChem.this, Mem.class);
                                    startActivity(it);
                                    etpf.setText("");
                                }
                            });
                    ...
                    final AlertDialog.Builder builder = new AlertDialog.Builder(com.administrator.d2d.ForgetPasswordChem.this);
                    TextView myMsg = new TextView(com.administrator.d2d.ForgetPasswordChem.this);
