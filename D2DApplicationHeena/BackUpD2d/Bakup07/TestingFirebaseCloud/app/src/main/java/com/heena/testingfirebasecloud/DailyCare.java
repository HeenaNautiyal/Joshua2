...
public class DailyCare extends AppCompatActivity {
    ...
    String abc, mobile, fname, address, city, state, license, email, Epdate, mail, mail1,result;
    TextView tv;
            ...
            public void onClick(View v) {
                ...
                for (int i = 0; i < countryList.size(); i++) {
                    Chemist actors = countryList.get(i);
                        ...
                        result = actors.getMedicine();
                        mobile = (Integer.toString(count));
                        Log.e(TAG, "selected Chemist: " + actors.getName());
                        selectionorder();
                }
                Log.e("Selected",result);
                Toast.makeText(getApplicationContext(),"Selected Product are :"+result,Toast.LENGTH_LONG).show();
            }
