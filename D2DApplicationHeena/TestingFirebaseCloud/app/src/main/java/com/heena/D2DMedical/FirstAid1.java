...
public class FirstAid1 extends AppCompatActivity {
    ...
    /*    getSupportActionBar().setDisplayOptions(android.support.v7.app.ActionBar.DISPLAY_SHOW_CUSTOM);
        ...
        new JSONAsyncTask().execute("http://d2dmedicine.com/aPPmob_lie/insertdata.php?caseid=27&catid=11");
        ...
        btnback.setOnClickListener(new View.OnClickListener() {
            ...
            public void onClick(View v) {
                Intent it = new Intent(FirstAid1.this,MainActivity3.class);
                startActivity(it);
            }
        });
    ...
    private void buildDialog(int dialogTheme, String s) {
        LayoutInflater layoutInflater = LayoutInflater.from(FirstAid1.this);
        final View promptView = layoutInflater.inflate(R.layout.input_dialog4, null);

        final AlertDialog.Builder alertDialogBuilder = new AlertDialog.Builder(FirstAid1.this);
