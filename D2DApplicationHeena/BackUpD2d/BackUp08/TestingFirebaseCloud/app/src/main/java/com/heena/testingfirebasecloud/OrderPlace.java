    ...
    protected void onCreate(Bundle savedInstanceState) {
        ...
        iv.setOnClickListener(new View.OnClickListener() {
            ...
            public void onClick(View v) {
                ...
                new JSONAsyncTask().execute("http://outsourcingservicesusa.com/d2d/insertdata.php?caseid=15&medicine=Saridon");
            }
        });
        ...
        btnback.setOnClickListener(new View.OnClickListener() {
            @Override
            public void onClick(View v) {
                Intent It = new Intent(OrderPlace.this, Main2Activity.class);
                startActivity(It);
            }
        });
    }
