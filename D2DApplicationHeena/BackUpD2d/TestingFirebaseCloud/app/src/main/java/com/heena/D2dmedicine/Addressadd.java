...
ImageView iv;
    ...
    Snackbar snackbar;
    EditText address2,city2,state2,pincode2,num1;
    String aaa,ddd,mail,name1,number1,address1,city,state1,pincode,stad,stcty,ststat,stpin,stnum;
    ...
    protected void onCreate(Bundle savedInstanceState) {
        ...
        new Logmem().execute("http://outsourcingservicesusa.com/d2d/insertdata.php?caseid=19&email="+mail+"");
    ...
    private class Logmem extends AsyncTask<String, Void, Boolean> {
        ...
        private class Registration extends AsyncTask<String, String, String> {
            ...
            protected String doInBackground(String... strings) {
                HttpClient httpClient = new DefaultHttpClient();
                String url = "http://outsourcingservicesusa.com/d2d/insertdata.php?caseid=18&email="+mail+"" +
                        "&mobileno="+stnum+"&pincode="+stpin+"&address="+stad.replaceAll(" ","%20")+"" +
                        "&city="+stcty.replaceAll(" ","%20")+"&state="+ststat.replaceAll(" ","%20")+"&newemail=%27";
            ...
            protected void onPostExecute(String result) {
                try {
                    ...
                    if (message.equals("1")) {
                        ...
                        builder.setMessage("Your Address has been successfully Registered.");
