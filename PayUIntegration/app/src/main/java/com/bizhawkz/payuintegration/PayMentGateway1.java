package com.bizhawkz.payuintegration;
...
public class PayMentGateway1 extends AppCompatActivity {
    WebView webView;
    Context activity;
    /**
     * Order Id
    ...
    protected void onCreate(Bundle savedInstanceState) {
        ...
        if (bundle != null) {
            ...
            mAmount = Double.parseDouble(bundle.getString("1"));//in my case amount getting as String so i parse it double
            ...
            webView.setWebViewClient(new WebViewClient() {
                ...
                public void onPageFinished(WebView view, String url) {
                    ...
                    if (url.equals(mSuccessUrl)) {
                        ...
                        Intent intent = new Intent(PayMentGateway1.this, PaymentStatusActivity.class);
            ...
            webView.addJavascriptInterface(new PayUJavaScriptInterface(PayMentGateway1.this), "PayUMoney");
    ...
    private void onPressingBack() {
        final Intent intent;
        if (isFromOrder) {
            //intent = new Intent(PayMentGateway1.this, ProductInCartList.class);
        }
        else
        {
            intent = new Intent(PayMentGateway1.this, MainActivity.class);

        intent.setFlags(Intent.FLAG_ACTIVITY_CLEAR_TOP);
        AlertDialog.Builder alertDialog = new AlertDialog.Builder(PayMentGateway1.this);
        ...
        public void success(long id, final String paymentId) {
            ...
            mHandler.post(new Runnable() {
                ...
                public void run() {
                    ...
                    mHandler = null;
                    Toast.makeText(PayMentGateway1.this, "Payment Successfully.", Toast.LENGTH_SHORT).show();
                    Intent intent = new Intent(PayMentGateway1.this, MainActivity.class);
    ...
    public ProgressDialog showProgress(Context context) {
        if (getApplicationContext() != null && !isFinishing()) {
            ...
            final Drawable[] drawables = {getResources().getDrawable(R.drawable.icon3),
