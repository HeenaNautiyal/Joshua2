...
public class Test3 extends AppCompatActivity {
    ...
    protected void onCreate(Bundle savedInstanceState) {
        ...
        actorsList = new ArrayList<Chemist>();
        new JSONAsyncTask().execute("http://outsourcingservicesusa.com/d2d/insertdata.php?caseid=23&chemist_email="+mail+"&catid=14");
        ...
        btnback.setOnClickListener(new View.OnClickListener() {
            ...
            public void onClick(View v) {
                Intent it = new Intent(Test.this,Main2Activity.class);
                startActivity(it);
            }
        });*/
        ...
        listview.setOnItemClickListener(new AdapterView.OnItemClickListener() {
            ...
            public void onItemClick(AdapterView<?> arg0, View arg1, int position, long id) {
                ...
                if (actors.getIsRowSelected()) {
                    ...
                    Intent it = new Intent(Test3.this, Chemis.class);
                   /* Bundle b = new Bundle();
