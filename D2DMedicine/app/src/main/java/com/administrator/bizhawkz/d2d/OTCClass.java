...
public class OTCClass extends AppCompatActivity {
    ...
    protected void onCreate(Bundle savedInstanceState) {
        ...
        setContentView(R.layout.activity_otcclass);
        ...
        new JSONAsyncTask().execute("http://seajob.net/medicalapp/insertdata.php?caseid=13&cat_id=1");
            ...
            public void onClick(View v) {
                ...
                for (Chemist actors : actorsList) {
                    if (actors.getIsRowSelected()) {
                        ...
                        Intent it = new Intent(OTCClass.this, NewDem.class);
    ...
    class JSONAsyncTask extends AsyncTask<String, Void, Boolean> {
        ...
        protected void onPreExecute() {
            super.onPreExecute();
            dialog = new ProgressDialog(OTCClass.this);
